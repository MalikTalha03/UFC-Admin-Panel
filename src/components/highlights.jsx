...
export function Highlights() {
  ...
  const fetchHighlights = async () => {
    try {
      ...
      alert("Failed to fetch highlights: " + error.message);
    }
  };
  ...
  return (
    <div className="grid min-h-screen w-full grid-cols-[280px_1fr] bg-gray-100 dark:bg-gray-950">
          ...
          <div className="border shadow-sm rounded-lg">
            <Table>
              ...
              <TableBody>
                {highlights.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan="3">No Highlights found.</TableCell>
                  </TableRow>
                ) : (
      ...
      {addHighlight && (
        <AddHighlight open={addHighlight} onChange={setAddHighlight} />
      )}
