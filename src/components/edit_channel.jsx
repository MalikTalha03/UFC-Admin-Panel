...
export function EditChannel({ open, onChange, channell }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/channels/${channell._id}`, {
        method: "PATCH",
    ...
    <Dialog open={open} onOpenChange={onChange}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update channel with a name and header.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setChannel({ ...channel, headers: e.target.value })
              }
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              onChange={(e) => setChannel({ ...channel, logo: e.target.value })}
              value={channel.logo}
            />
          </div>
        </div>
